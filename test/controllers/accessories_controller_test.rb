...
class AccessoriesControllerTest < ActionController::TestCase
  ...
  test "should create accessory" do
    assert_difference('Accessory.count') do
      post :create, accessory: { description: @accessory.description, manufacturer: @accessory.manufacturer, price: @accessory.price, title: @accessory.title }
    end
  ...
  test "should update accessory" do
    patch :update, id: @accessory, accessory: { description: @accessory.description, manufacturer: @accessory.manufacturer, price: @accessory.price, title: @accessory.title }
    assert_redirected_to accessory_path(assigns(:accessory))
  end
