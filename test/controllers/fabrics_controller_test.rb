...
class FabricsControllerTest < ActionController::TestCase
  ...
  test "should create fabric" do
    assert_difference('Fabric.count') do
      post :create, fabric: { color: @fabric.color, manufacturer: @fabric.manufacturer, price: @fabric.price, size: @fabric.size, title: @fabric.title }
    end
  ...
  test "should update fabric" do
    patch :update, id: @fabric, fabric: { color: @fabric.color, manufacturer: @fabric.manufacturer, price: @fabric.price, size: @fabric.size, title: @fabric.title }
    assert_redirected_to fabric_path(assigns(:fabric))
  end
