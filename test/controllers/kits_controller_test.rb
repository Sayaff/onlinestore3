...
class KitsControllerTest < ActionController::TestCase
  ...
  test "should create kit" do
    assert_difference('Kit.count') do
      post :create, kit: { containment: @kit.containment, description: @kit.description, price: @kit.price, title: @kit.title }
    end
  ...
  test "should update kit" do
    patch :update, id: @kit, kit: { containment: @kit.containment, description: @kit.description, price: @kit.price, title: @kit.title }
    assert_redirected_to kit_path(assigns(:kit))
  end
